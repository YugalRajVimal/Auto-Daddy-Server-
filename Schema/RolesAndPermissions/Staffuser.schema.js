...
const StaffUserSchema = new mongoose.Schema(
  {
    ...
    // Set to the JWT issued on the most recent real login (adminVerifyAccount).
    ...
    // Impersonation tokens (loginAsStaffUser) intentionally never touch this
    // field — impersonating a staff account shouldn't sign out their real session.
