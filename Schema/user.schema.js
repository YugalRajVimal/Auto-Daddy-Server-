...
//     // NEW: Onboarding approval flow (Admin/Staff onboards a Shop Owner ->
//     // owner gets an SMS with an approve/reject link -> stays "pending"
//     // until they respond).
//     onboardingStatus: {
//       type: String,
...
//       default: "pending",
//     },
//     onboardingApprovalToken: { type: String, default: null, index: true },
//     onboardingTokenExpiresAt: { type: Date, default: null },
//     // Who onboarded this user (StaffUser doc — admin/role_admin/sub_admin/associates)
//     onboardedByStaff: { type: mongoose.Schema.Types.ObjectId, ref: "StaffUser", default: null },
//     onboardedByStaffName: { type: String, default: null },
//     onboardedByStaffRole: { type: String, default: null },
//     onboardingRespondedAt: { type: Date, default: null },
...
const UserSchema = new mongoose.Schema(
  {
    ...
    // Set to the JWT issued on the most recent real login (verifyAccount).
    // jwtAuth rejects any older token that doesn't match this, so logging in
    // anywhere immediately signs this account out everywhere else.
    // Impersonation tokens (loginAs) intentionally never touch this field —
    // an admin impersonating this user shouldn't sign out their real session.
