...
import { handleStripeWebhook } from "./Routers/AutoShops/subscription.routes.js";
...
// ─────────────────────────────────────────────────────────────
// OPEN CORS — public storefront data + a handful of write-only
// endpoints (contact form, onboarding approve/reject links) that
// are meant to be called from any of your brand domains with no
// auth. Security for those is enforced by the route handlers
// themselves (single-use tokens, validation, rate limiting) —
// not by CORS — nothing sensitive is ever returned here.
// ─────────────────────────────────────────────────────────────
